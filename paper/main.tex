...
\date{2026-06-16 \\ \small Source: \texttt{github.com/Flamehaven-Labs/QSOT2-Compiler}}
...
and the model trajectory. The reference run over six spacetime backgrounds emits a
